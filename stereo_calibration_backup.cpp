...
bool loadCalibrationXML(const std::string& filename, StereoCalibrationResult& result) {
    ...
    // Read camera matrices - these seem to be stored incorrectly in the XML
    // Let's manually construct them from the MATLAB parameters
    ...
    result.reprojectionError = 0.0; // MATLAB didn't provide this in the XML
    result.success = true;
...
bool compareMatlabCalibration(const StereoCalibrationResult& cvResult, 
    ...
    std::cout << "OpenCV: " << cvResult.distCoeffs1 << std::endl;
    ...
    std::cout << "OpenCV: " << cvResult.distCoeffs2 << std::endl;
    
    std::cout << "\nRotation Matrix:" << std::endl;
    std::cout << "OpenCV: " << cvResult.R << std::endl;
    
    std::cout << "\nTranslation Vector:" << std::endl;
    std::cout << "OpenCV: " << cvResult.T << std::endl;
...
StereoCalibrationResult calibrateStereoCamera(const std::string& leftCornerFolder,
    ...
    // This function would typically load corner data from files
    // For now, we'll implement a placeholder that loads from the MATLAB XML
    StereoCalibrationResult result;
    result.success = false;
    
    // Try to load existing calibration from MATLAB XML
